      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-yellow-500/15 bg-yellow-500/5 p-4">
              ...
              <ul className="space-y-1.5">
                {course.certificationRelated.map((cert) => (
                  <li key={cert} className="flex items-center gap-2 text-xs text-yellow-400/80">
                    <span className="w-1 h-1 rounded-full bg-yellow-500/50 shrink-0" />
                    {cert}
                  </li>
                ))}
              </ul>
          ...
          {courseModule && (
            ...
            >
              <span className="text-lg">{courseModule.icon}</span>
